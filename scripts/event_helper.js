...
(function (porcelain) {
    ...
    *
    * The attached events will be removed when the helper is destroyed.
    *
    * @class
    */
    var EventHelper = (function () {
        ...
        */
        function EventHelper(item, target, prefix) {
            this._events = [];
            this._item = item;
            this._target = target;
            this._prefix = prefix;
        ...
        */
        ...
        Object.defineProperty(EventHelper.prototype, "item", {
            /**
        ...
        Object.defineProperty(EventHelper.prototype, "target", {
            /**
        ...
        Object.defineProperty(EventHelper.prototype, "events", {
            /**
        ...
        */
        EventHelper.prototype.enable = function () {
            var events = [];
        ...
        */
        EventHelper.prototype.disable = function () {
            var events = [];
            for (var _i = 0; _i < (arguments.length - 0); _i++) {
                events[_i] = arguments[_i + 0];
            }
        ...
        * @private
        */
        EventHelper.prototype.handleEvent = function (event) {
